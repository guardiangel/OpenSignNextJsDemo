import { handleDownloadPdf, OpenSignServerURL, XParseApplicationId } from "@newComponents/opensigncomponents/constant/Utils";
import ModalUi from "@newComponents/opensigncomponents/primitives/ModalUi";
import FolderModal from "@newComponents/opensigncomponents/shared/fields/FolderModal";
...
function DriveBody(props) {
  ...
  const handledRenameDoc = async (data) => {
    ...
    if (trimmedValue.length > 0) {
      ...
      await axios
        .put(
          `${OpenSignServerURL}/classes/contracts_Document/${docId}`,
          updateName,
          {
            headers: {
  ...
  const handleMoveFolder = async (selectFolderData) => {
    ...
    if (!checkExist) {
      ...
      await axios
        .put(
          `${OpenSignServerURL}/classes/contracts_Document/${updateDocId}`,
          updateData,
          {
            headers: {
              "Content-Type": "application/json",
