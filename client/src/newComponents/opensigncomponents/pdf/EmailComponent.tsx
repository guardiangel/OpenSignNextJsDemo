import { AVATAR_URL, fileAdapterId_common, handleToPrint, OpenSignServerURL, XParseApplicationId } from "@newComponents/opensigncomponents/constant/Utils";
import { emailRegex, themeColor } from "@newComponents/opensigncomponents/constant/const";
  ...
  const sendEmail = async () => {
    ...
    for (let i = 0; i < emailList.length; i++) {
      try {
        ...
        console.log("EmailComponent.tsx imgPng:", imgPng);
        ...
        let params = {
          ...
          html:
            ...
            pdfName +
            " </strong>is attached to this email. Kindly download the document from the attachment.</p></div> </div><div><p>This is an automated email from VassuTech™. For any queries regarding this email, please contact the sender " +
            sender.email +
