import { copytoData } from "@newComponents/opensigncomponents/constant/Utils";
...
function EmbedTab(props) {
  ...
  const reactCode = [
    {
      id: 0,
      title: "Installation",
      codeString: `yarn add @opensign/react`
    },
    {
      id: 1,
      title: "Usage",
  ...
  const angularCode = [
    {
      id: 0,
      title: "Installation",
      codeString: `yarn add @opensign/angular`
    },
    {
      id: 1,
      title: "Usage",
  ...
  const jsCodeString = `
<script
  src= "/js/public-template.bundle.js"
  id="opensign-script"
  templateId=${props.templateId}
  ></script>
  `;
