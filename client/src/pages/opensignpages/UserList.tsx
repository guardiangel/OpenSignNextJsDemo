import pad from "@/newComponents/opensigncomponents/assets/images/pad.svg";
import { isEnableSubscription } from "@/newComponents/opensigncomponents/constant/const";
import { fetchSubscriptionInfo } from "@/newComponents/opensigncomponents/constant/Utils";
import { validplan } from "@/newComponents/opensigncomponents/json/plansArr";
...
const UserList = () => {
  ...
  //35KBoSgoAK defined in menuJson.js. Here it's used to show if in the /dashboard.(From samples project, we don't need it probably)
  const isDashboard =
  pathname === "/dashboard/35KBoSgoAK" ? true : false;
