...
import { emailRegex } from "@/newComponents/opensigncomponents/constant/const";
import {
  getAppLogo,
  OpenSignServerURL,
  saveLanguageInLocal,
...
const AddAdmin = () => {
 ...
 // const dispatch = useDispatch();
  ...
  const handleSubmit = async (event) => {
    console.log("AddAdmin handleSubmit................................");
  ...
  const handleNavigation = async (sessionToken) => {
    console.log("handleNavigation sessionToken=",sessionToken);
  ...
  const subscribeNewsletter = async () => {
    try {
      const params = { name: name, email: email, domain: process.env.WINDOW_LOCAL_HOST};
