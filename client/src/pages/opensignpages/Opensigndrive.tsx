import { iconColor } from "@/newComponents/opensigncomponents/constant/const";
import { getDrive, OpenSignServerURL, XParseApplicationId } from "@/newComponents/opensigncomponents/constant/Utils";
...
const DriveBody = React.lazy(
  () => import("../../newComponents/opensigncomponents/opensigndrive/DriveBody")
);
const AppLoader = () => {
  return (
              ...
              >
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <span
                      className="dropdown-item text-[10px] md:text-[13px]"
                      onClick={() => router.push("/opensignpages/OpenSignForm?id=sHAnZphf69")}
                    >
                    ...
                    <span
                      className="dropdown-item text-[10px] md:text-[13px]"
                      onClick={() => router.push("/opensignpages/OpenSignForm?id=8mZzFxbG1z")}
                    >
